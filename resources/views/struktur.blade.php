  ...
  <section class="w-full bg-white">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-8">
        ...
        {{-- Struktur Organisasi --}}
        <h2 class="text-2xl font-bold text-gray-900 text-center">Struktur Organisasi</h2>
...
{{-- GRID KARYAWAN --}}
{{-- Karyawan --}}
<h2 class="text-2xl font-bold text-gray-900 text-center mt-2">Karyawan KGTK</h2>
...
<div class="mt-8"
    ...
    @forelse($employees as $emp)
      ...
      <button type="button"
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden
          ...
          {{-- area foto: tinggi seragam --}}
          <div class="h-44 sm:h-52 bg-gray-50 overflow-hidden">
            <img src="{{ $photo }}"
                 alt="{{ $emp->name }}"
                 class="w-full h-full object-cover object-center
                        group-hover:scale-[1.04] transition duration-300">
          </div>
  ...
  {{-- MODAL DETAIL (biarkan punyamu, sudah ok) --}}
  <div x-show="open"
    ...
    <div class="relative w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden"
      ...
      <div class="p-5 grid sm:grid-cols-[220px_1fr] gap-5">
        <div class="bg-gray-50 rounded-xl overflow-hidden flex items-center justify-center">
          <img :src="selected?.photo" :alt="selected?.name" class="w-full h-full object-cover object-center">
        </div>
