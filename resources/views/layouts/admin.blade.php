...
<body class="bg-gray-100" x-data="{ sidebarOpen: false }">
    <div class="flex h-screen overflow-hidden">
        ...
        >
            ...
            class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-blue-800 hover:text-white transition duration-200 {{ request()->routeIs('Dashboard.*') ? 'bg-blue-800 text-white' : '' }}">
                ...
                <!-- Layanan  -->
                {{-- <a href="{{ route('admin.news.index') }}" 
                class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-blue-800 hover:text-white transition duration-200 {{ request()->routeIs('') ? 'bg-blue-800 text-white' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
