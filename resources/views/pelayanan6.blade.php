@extends('layouts.app')
@section('content')
@section('title', 'Pelayanan Fasilitas Peningkatan Kompetensi')
    ...
    <li class="text-gray-700 font-medium">
      @yield('title')
        ...
        <div class="flex items-center gap-4 mb-6">
          <h2 class="text-3xl font-bold text-gray-900">Pelayanan Fasilitas Peningkatan Kompetensi</h2>
