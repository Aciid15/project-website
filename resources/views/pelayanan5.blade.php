@extends('layouts.app')
@section('content')
@section('title', 'Pelayanan Peminjaman Sarana Prasarana')
    ...
    <li class="text-gray-700 font-medium">
      @yield('title')
        ...
        <div class="flex items-center gap-4 mb-6">
          <h2 class="text-3xl font-bold text-gray-900">Pelayanan Peminjaman Sarana Prasarana</h2>
